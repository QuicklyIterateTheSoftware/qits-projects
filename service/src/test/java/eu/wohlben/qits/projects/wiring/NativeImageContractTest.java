 ...
 * see it — the same rule qits-artifacts' {@code CiPostReceiveNotifier} states: a {@code static}
 * {@link HttpClient} is built at image-build time, and native-image refuses the {@code
 * HttpClientFacade} that lands in the heap.
 *
