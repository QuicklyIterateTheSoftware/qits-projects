 ...
 * up and read its own {@code /projects/q/openapi}. It asserts nothing — the assertion is the diff.
 *
...
public class OpenApiSchemaExportTest {
  ...
  public void exportOpenApiSchema() throws Exception {
    String schema = given().when().get("/projects/q/openapi").then().statusCode(200).extract().asString();
