 ...
 * target/qits-test-host/<repoId>.git}, standing in for qits-artifacts' git host
 ...
 * <em>transport</em> — there is no HTTP hop and no {@code ProtectedRefHook}, which is qits-artifacts'
 * and proven there.
 *
